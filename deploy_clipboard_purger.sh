...
echo -e "\033[1;34m[1/2] Engineering Automated Clipboard Privacy Purger...\033[0m"

cat << 'PYEOF' > clipboard_purger.py
...
echo -e "\033[1;34m[2/2] Testing secure host clipboard ingestion loops...\033[0m"
chmod +x clipboard_purger.py
xvfb-run -a ./.venv/bin/python3 clipboard_purger.py 2>/dev/null || ./.venv/bin/python3 clipboard_purger.py
