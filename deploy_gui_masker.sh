...
echo -e "\033[1;34m[1/2] Deploying Repaired Privacy-Preserving UI View Port Masker...\033[0m"

cat << 'PYEOF' > gui_masker.py
...
echo -e "\033[1;34m[2/2] Validating inline visual redaction mechanics...\033[0m"
chmod +x gui_masker.py
xvfb-run -a ./.venv/bin/python3 gui_masker.py 2>/dev/null || ./.venv/bin/python3 gui_masker.py
