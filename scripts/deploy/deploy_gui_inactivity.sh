...
echo -e "\033[1;34m[1/2] Deploying In-Memory User Inactivity Sleep Shield...\033[0m"

cat << 'PYEOF' > gui_inactivity.py
...
echo -e "\033[1;34m[2/2] Validating low-overhead input event tap streams...\033[0m"
chmod +x gui_inactivity.py
xvfb-run -a ./.venv/bin/python3 gui_inactivity.py 2>/dev/null || ./.venv/bin/python3 gui_inactivity.py
