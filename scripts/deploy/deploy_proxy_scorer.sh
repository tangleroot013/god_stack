...
echo -e "\033[1;34m[1/2] Constructing Proxy Egress Performance Scorer...\033[0m"

cat << 'PYEOF' > proxy_scorer.py
import logging
...
echo -e "\033[1;34m[2/2] Running runtime trace evaluation test loop...\033[0m"
chmod +x proxy_scorer.py
./.venv/bin/python3 proxy_scorer.py
