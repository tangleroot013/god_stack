...
echo -e "\033[1;34m[1/2] Initiating File Descriptor Leakage Watchdog...\033[0m"

cat << 'PYEOF' > descriptor_watchdog.py
import os
import sys
import logging
...
echo -e "\033[1;34m[2/2] Running host stream descriptor integrity validation...\033[0m"
chmod +x descriptor_watchdog.py
./.venv/bin/python3 descriptor_watchdog.py
