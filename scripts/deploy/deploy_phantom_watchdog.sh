...
echo -e "\033[1;34m[1/2] Fabricating Phantom Watchdog Subsystem...\033[0m"

cat << 'PYEOF' > phantom_watchdog.py
import asyncio
import logging
import time
...
chmod +x phantom_watchdog.py
./.venv/bin/python3 phantom_watchdog.py
