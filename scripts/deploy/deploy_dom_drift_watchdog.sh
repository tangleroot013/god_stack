...
echo -e "\033[1;34m[1/2] Deploying Structural Layout Drift Watchdog...\033[0m"

cat << 'PYEOF' > dom_drift_watchdog.py
import hashlib
import logging
...
echo -e "\033[1;34m[2/2] Running structural mutation trace validation checks...\033[0m"
chmod +x dom_drift_watchdog.py
./.venv/bin/python3 dom_drift_watchdog.py
