...
echo -e "\033[1;34m[1/2] Compiling Node Bootstrapping Manifest Generator...\033[0m"

cat << 'PYEOF' > generate_manifest.py
import json
import time
import socket
import logging
...
echo -e "\033[1;34m[2/2] Instantiating manifest file compilation test...\033[0m"
chmod +x generate_manifest.py
./.venv/bin/python3 generate_manifest.py
