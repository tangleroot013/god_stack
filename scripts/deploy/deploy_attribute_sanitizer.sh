...
echo -e "\033[1;34m[1/2] Organizing Dynamic Semantic Attribute Sanitizer...\033[0m"

cat << 'PYEOF' > attribute_sanitizer.py
import logging
...
echo -e "\033[1;34m[2/2] Running attribute extraction purity test...\033[0m"
chmod +x attribute_sanitizer.py
./.venv/bin/python3 attribute_sanitizer.py
