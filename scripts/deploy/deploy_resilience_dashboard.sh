...
echo -e "\033[1;34m[1/2] Constructing Real-Time Resilience Dashboard Widget...\033[0m"

cat << 'PYEOF' > resilience_dashboard.py
...
echo -e "\033[1;34m[2/2] Running async dashboard indicator evaluations...\033[0m"
chmod +x resilience_dashboard.py
xvfb-run -a ./.venv/bin/python3 resilience_dashboard.py 2>/dev/null || ./.venv/bin/python3 resilience_dashboard.py
