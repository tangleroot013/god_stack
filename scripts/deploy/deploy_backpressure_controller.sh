...
echo -e "\033[1;34m[1/2] Constructing Hardware Rate Control Subsystem...\033[0m"

cat << 'PYEOF' > run_backpressure_controller.py
import asyncio
import logging
import random
...
./.venv/bin/python3 run_backpressure_controller.py
