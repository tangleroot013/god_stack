...
echo -e "\033[1;34m[1/2] Installing Telemetry Sync Grid Bridge...\033[0m"

cat << 'PYEOF' > telemetry_sync.py
import logging
import sys
...
chmod +x telemetry_sync.py
./.venv/bin/python3 telemetry_sync.py
