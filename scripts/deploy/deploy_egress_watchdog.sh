...
echo -e "\033[1;34m[1/2] Deploying Autonomous Egress Node Health Watchdog...\033[0m"

cat << 'PYEOF' > egress_watchdog.py
import asyncio
import logging
import random
...
chmod +x egress_watchdog.py
./.venv/bin/python3 egress_watchdog.py
