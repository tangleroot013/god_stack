...
echo -e "\033[1;34m[1/2] Generating Cluster Node Identity Allocation Matrix...\033[0m"

cat << 'PYEOF' > node_coordinator.py
import uuid
import socket
import hashlib
import logging
...
echo -e "\033[1;34m[2/2] Initializing identity registration check loops...\033[0m"
chmod +x node_coordinator.py
./.venv/bin/python3 node_coordinator.py
