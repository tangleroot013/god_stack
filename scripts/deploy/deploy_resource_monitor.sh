...
echo -e "\033[1;34m[1/2] Constructing Local Process Resource Boundary Monitor...\033[0m"

cat << 'PYEOF' > resource_monitor.py
...
echo -e "\033[1;34m[2/2] Launching internal canvas vector engine tests...\033[0m"
chmod +x resource_monitor.py
xvfb-run -a ./.venv/bin/python3 resource_monitor.py 2>/dev/null || ./.venv/bin/python3 resource_monitor.py
