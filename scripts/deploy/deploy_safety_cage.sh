...
echo -e "\033[1;34m[1/2] Erecting Hot-Swappable Module Runtime Safety Cage...\033[0m"

cat << 'PYEOF' > safety_cage.py
import importlib
import logging
...
echo -e "\033[1;34m[2/2] Triggering dynamic safety isolation tests...\033[0m"
chmod +x safety_cage.py
./.venv/bin/python3 safety_cage.py
