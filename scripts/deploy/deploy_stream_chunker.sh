...
echo -e "\033[1;34m[1/2] Deploying Asynchronous Streaming Payload Chunker...\033[0m"

cat << 'PYEOF' > stream_chunker.py
import asyncio
import json
import logging
...
chmod +x stream_chunker.py
./.venv/bin/python3 stream_chunker.py
