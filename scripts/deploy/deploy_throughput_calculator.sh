...
echo -e "\033[1;34m[1/2] Constructing Sliding-Window Throughput Calculator...\033[0m"

cat << 'PYEOF' > throughput_calculator.py
import time
import logging
import collections
...
echo -e "\033[1;34m[2/2] Launching window velocity verification tests...\033[0m"
chmod +x throughput_calculator.py
./.venv/bin/python3 throughput_calculator.py
