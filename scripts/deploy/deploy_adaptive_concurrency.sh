...
echo -e "\033[1;34m[1/2] Injecting Adaptive Concurrency Scaling Matrix...\033[0m"

cat << 'PYEOF' > adaptive_concurrency.py
import asyncio
import logging
import random
...
chmod +x adaptive_concurrency.py
./.venv/bin/python3 adaptive_concurrency.py
