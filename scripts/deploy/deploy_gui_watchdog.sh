...
echo -e "\033[1;34m[1/2] Fabricating Visual Thread Lockup Watchdog...\033[0m"

cat << 'PYEOF' > gui_watchdog.py
...
echo -e "\033[1;34m[2/2] Validating main loop keepalive scheduling states...\033[0m"
chmod +x gui_watchdog.py
xvfb-run -a ./.venv/bin/python3 gui_watchdog.py 2>/dev/null || ./.venv/bin/python3 gui_watchdog.py
