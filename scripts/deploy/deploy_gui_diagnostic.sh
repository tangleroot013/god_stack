...
echo -e "\033[1;34m[1/2] Engineering Ephemeral Diagnostic HUD Toggle...\033[0m"

cat << 'PYEOF' > gui_diagnostic.py
...
echo -e "\033[1;34m[2/2] Registering hotkey input catch arrays...\033[0m"
chmod +x gui_diagnostic.py
xvfb-run -a ./.venv/bin/python3 gui_diagnostic.py 2>/dev/null || ./.venv/bin/python3 gui_diagnostic.py
