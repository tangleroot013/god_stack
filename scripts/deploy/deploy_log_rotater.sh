...
echo -e "\033[1;34m[1/2] Deploying Automated Structured Log Rotater...\033[0m"

cat << 'PYEOF' > log_rotater.py
import os
import logging
...
echo -e "\033[1;34m[2/2] Running runtime trace retention checks...\033[0m"
chmod +x log_rotater.py
./.venv/bin/python3 log_rotater.py
