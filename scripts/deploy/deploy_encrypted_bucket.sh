...
echo -e "\033[1;34m[1/2] Deploying Ephemeral Encrypted Cache Bucket...\033[0m"

cat << 'PYEOF' > encrypted_bucket.py
import os
import logging
...
echo -e "\033[1;34m[2/2] Validating temporary memory masking loops...\033[0m"
chmod +x encrypted_bucket.py
./.venv/bin/python3 encrypted_bucket.py
