...
echo -e "\033[1;34m[1/2] Fabricating Memory-Bounded Sliding Log Ring...\033[0m"

cat << 'PYEOF' > log_ring.py
import logging
import collections
...
echo -e "\033[1;34m[2/2] Running buffer overflow saturation tests...\033[0m"
chmod +x log_ring.py
./.venv/bin/python3 log_ring.py
