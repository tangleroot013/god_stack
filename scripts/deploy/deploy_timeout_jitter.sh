...
echo -e "\033[1;34m[1/2] Launching Dynamic Network Timeout Jitter Calculator...\033[0m"

cat << 'PYEOF' > timeout_jitter.py
import logging
import random
...
echo -e "\033[1;34m[2/2] Validating timeout entropy bounds...\033[0m"
chmod +x timeout_jitter.py
./.venv/bin/python3 timeout_jitter.py
