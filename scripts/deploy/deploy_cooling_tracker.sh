...
echo -e "\033[1;34m[1/2] Erecting Asynchronous Rate-Limit Cooling Index Tracker...\033[0m"

cat << 'PYEOF' > cooling_tracker.py
import asyncio
import time
import logging
...
echo -e "\033[1;34m[2/2] Running runtime constraint track checks...\033[0m"
chmod +x cooling_tracker.py
./.venv/bin/python3 cooling_tracker.py
