...
echo -e "\033[1;34m[1/2] Fabricating Network Backoff Visualization Tracking Gauge...\033[0m"

cat << 'PYEOF' > network_backoff.py
...
echo -e "\033[1;34m[2/2] Running simulated transport error injections...\033[0m"
chmod +x network_backoff.py
xvfb-run -a ./.venv/bin/python3 network_backoff.py 2>/dev/null || ./.venv/bin/python3 network_backoff.py
