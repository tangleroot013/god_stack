...
echo -e "\033[1;34m[1/2] Deploying Repaired Volatile Session Purger...\033[0m"

cat << 'PYEOF' > session_purger.py
import logging
...
echo -e "\033[1;34m[2/2] Verifying volatile memory scrub operations...\033[0m"
chmod +x session_purger.py
./.venv/bin/python3 session_purger.py
