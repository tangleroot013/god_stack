...
class UrlSanitizer:
    ...
    def normalize(raw_url: str, strip_trackers: bool = True) -> str:
        ...
        # Enforce scheme baseline if dropped by mistake (case-insensitive evaluation)
        ...
        try:
            ...
            if strip_trackers:
                # Discard common click-tracking / telemetry metrics
...
if __name__ == "__main__":
    ...
    # Dirty test matrix targeting common crawler variations
    dirty_urls = [
