...
echo -e "\033[1;34m[1/2] Fabricating Asynchronous HTTP Heartbeat Server...\033[0m"

cat << 'PYEOF' > heartbeat_server.py
import asyncio
import logging
...
echo -e "\033[1;34m[2/2] Triggering loop-back socket connectivity test...\033[0m"
chmod +x heartbeat_server.py
