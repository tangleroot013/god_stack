...
echo -e "\033[1;34m[1/2] Erecting Network Interface Affinity Router...\033[0m"

cat << 'PYEOF' > affinity_router.py
import socket
import logging
...
echo -e "\033[1;34m[2/2] Running system socket descriptor override loop...\033[0m"
chmod +x affinity_router.py
./.venv/bin/python3 affinity_router.py
